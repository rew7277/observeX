  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-400 md:text-base">Set up the hybrid ingestion layer so the product can grow beyond manual uploads into scheduled collection and archived storage.</p>
      </header>
