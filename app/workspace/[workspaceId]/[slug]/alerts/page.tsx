  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">Alerts center</h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-400 md:text-base">Extend this page into rule engines, alert thresholds, and AI summaries.</p>
      </header>
