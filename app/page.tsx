...
import { ArrowRight, Shield, UploadCloud, Workflow, BarChart3, BellRing, Lock } from "lucide-react";
import { Panel } from "@/components/panel";

const features = [
  {
    title: "Drag & drop ingestion",
    copy: "Upload log files directly and transform them into searchable records, operational views, and visual analytics.",
    icon: UploadCloud
  },
  {
    title: "Flow and trace analysis",
    copy: "Track application flow hops, request traces, and likely bottlenecks from the data you actually upload.",
    icon: Workflow
  },
  {
    title: "Executive-grade dashboards",
    copy: "Beautiful SaaS visuals for reliability, alerting, latency, application load, and environment health.",
    icon: BarChart3
  },
  {
    title: "Role-ready security posture",
    copy: "Built with workspace-aware auth, protected sessions, and room for RBAC expansion.",
    icon: Lock
  },
  {
    title: "Alert-centric investigation",
    copy: "Turn warnings and errors into actionable operational summaries for engineering and business teams.",
    icon: BellRing
  },
  {
    title: "Compliance-friendly observability",
    copy: "Perfect base for PII masking, policy checks, audit views, and security analytics modules.",
    icon: Shield
  }
];
        ...
        <div>
          ...
          <h1 className="mt-5 text-5xl font-semibold tracking-tight leading-[1.02] md:text-7xl">
            ...
            <span className="block bg-gradient-to-r from-cyan-300 via-sky-300 to-violet-300 bg-clip-text text-transparent">
              for secure multi-environment systems
            </span>
          </h1>
          <p className="mt-5 max-w-3xl text-base leading-8 text-slate-400 md:text-lg">
            A production deployable SaaS foundation with landing page, auth flow, workspace architecture, drag-and-drop uploads, real log parsing, and premium dashboards for teams running APIs, platforms, and operational systems.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              ["Multi-workspace", "Tenant-style workspace URL structure"],
              ["Real uploads", "Dashboard fed by uploaded log content"],
              ["Railway ready", "GitHub + Railway deployment path included"]
            ].map(([title, desc]) => (
        ...
        <Panel className="overflow-hidden p-4 md:p-6">
          <div className="rounded-[24px] border border-white/10 bg-slate-950/40 p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="badge">Live-ready UI</div>
            </div>

            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {[
                ["48.2M", "Logs Ingested"],
                ["286 ms", "Avg Trace Latency"],
                ["14", "Open Alerts"],
                ["98.7%", "Masked Fields"]
              ].map(([value, label]) => (
            ...
            <div className="mt-5 rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
              ...
              <div className="mt-3 grid gap-3 text-sm text-slate-200 md:grid-cols-2">
                ...
                <div className="rounded-2xl bg-white/[0.04] p-4">Real parsing and charting</div>
      ...
      <section className="mx-auto mt-16 max-w-7xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-base leading-7 text-slate-400">
            This starter gives you the right foundation to keep extending into alerting, masking, RCA summaries, role-based access, API integrations, and long-term multi-tenant operations.
          </p>
        </div>
