...
// FIX #5 — Transaction timeout: prevent a 15MB upload holding a transaction
// open for minutes and exhausting the Prisma connection pool.
...
export type WebhookEvent = {
  timestamp?: string; level?: string; application?: string; environment?: string;
  traceId?: string; latencyMs?: number; message: string;
  [key: string]: unknown;
};
